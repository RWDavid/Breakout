...
void Shader::Compile(const GLchar* vertexSource, const GLchar* fragmentSource, const GLchar* geometrySource)
{
	...
	// If geometry shader source code is given, geometry shader is also compiled
	...
	// Delete the shaders since they're linked into our program now and no longer necessary
...
void Shader::checkCompileErrors(GLuint object, std::string type)
{
	...
	// Checking for vertex, fragment, and geometry shaders
	if (type != "PROGRAM")
	{
	...
	// Checking for program/shader object
	else
	{
